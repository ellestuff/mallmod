...
function MirrorArea:drawCharacter(chara)
    ...
    if tex_in_actor_spr_path then
        ...
        if mirror_sprites and mirror_sprites[tex_name_rel] or self.altmirror[tex_name_rel] then
            local new_frames = Assets.getFramesOrTexture(actor_spr_path .. (self.altmirror[tex_name_rel] or mirror_sprites[tex_name_rel])) or {}
    ...
    love.graphics.translate(-chara.width*chara.scale_x, -chara.y)
